...
\node[box, below=of b_agents] (b_lookup) {Food knowledge base};
...
\node[title, above=1.5mm of b_frame.north] {\texttt{baseline}};

% --- totaller-only ---
\node[box, right=16mm of b_agents] (t_agents) {Nutrition agent};
\node[box, below=of t_agents] (t_lookup) {Food knowledge base};
...
\node[title, above=1.5mm of t_frame.north] {\texttt{totaller-only}};

% --- reflection-only ---
\node[box, below=18mm of b_ref] (r_agents) {Nutrition agent};
\node[box, below=of r_agents] (r_lookup) {Food knowledge base};
...
\node[title, above=1.5mm of r_frame.north] {\texttt{reflection-only}};

% --- full ---
\node[box, right=16mm of r_agents] (f_agents) {Nutrition agent};
\node[box, below=of f_agents] (f_lookup) {Food knowledge base};
...
\node[title, above=1.5mm of f_frame.north] {\texttt{full}};

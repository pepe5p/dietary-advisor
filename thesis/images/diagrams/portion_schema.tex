\begin{tikzpicture}[
    rec/.style={draw, rectangle split, align=left, text width=42mm, inner sep=1.8mm, font=\scriptsize},
...
\draw[-{Latex[length=2mm]}] (before.four east)
    -- node[above, font=\scriptsize, align=center] {every nutrient\\ field deleted} (after.west |- before.four east);
